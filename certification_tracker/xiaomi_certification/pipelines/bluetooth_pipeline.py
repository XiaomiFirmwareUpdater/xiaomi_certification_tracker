...
from certification_tracker.xiaomi_certification.database.models.bluetooth import Item
from certification_tracker.xiaomi_certification.database.tables.bluetooth import create_table
