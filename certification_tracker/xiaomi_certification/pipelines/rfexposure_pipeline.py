...
from certification_tracker.xiaomi_certification.database.models.rfexposure import Item
from certification_tracker.xiaomi_certification.database.tables.rfexposure import create_table
