...
from certification_tracker.xiaomi_certification.database.models.bis import Item
from certification_tracker.xiaomi_certification.database.tables.bis import create_table
