...
from certification_tracker.xiaomi_certification.database.models.miit import Item
from certification_tracker.xiaomi_certification.database.tables.miit import create_table
