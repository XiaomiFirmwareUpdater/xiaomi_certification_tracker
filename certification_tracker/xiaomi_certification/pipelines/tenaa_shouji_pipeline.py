...
from certification_tracker.xiaomi_certification.database.models.tenaa_shouji import Item
from certification_tracker.xiaomi_certification.database.tables.tenaa_shouji import create_table
