...
from certification_tracker.xiaomi_certification.database.models.tenaa_cert import Item
from certification_tracker.xiaomi_certification.database.tables.tenaa_cert import create_table
